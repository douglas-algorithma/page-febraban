...
**3. Suíte Playwright** — 5 specs:

| Spec | O que garante |
|---|---|
| `manifest.spec.js` | cada cena renderiza o título do manifesto; chips e aplicações completos; a mandala lista exatamente as soluções |
...
Aconteceu três vezes neste projeto, e vale o registro:
